...
# PIX: só ative (True) quando aparecer "PIX" em Settings → Payment methods no Dashboard Stripe (pode ser convite/60 dias).
STRIPE_PIX_ENABLED = config('STRIPE_PIX_ENABLED', default=False, cast=bool)
