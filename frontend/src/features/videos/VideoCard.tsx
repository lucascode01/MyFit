...
export function VideoCard({ video, onClick }: VideoCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="card text-left w-full overflow-hidden hover:border-brand-orange/50 active:border-brand-orange/50 transition-colors touch-manipulation rounded-xl"
    >
